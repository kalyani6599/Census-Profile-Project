...
public class MemberInformationController {
	...
	public ResponseEntity<MemberInformation> updateMemberInformation(@PathVariable Integer id, @RequestBody MemberInformation memberInformation) {
		
			
			try {
				MemberInformation e= memberInformationService.getMemberInformationById(id);
				e.setFirstName(memberInformation.getFirstName());
				e.setLastName(memberInformation.getLastName());
				e.setGender(memberInformation.getGender());
				e.setAge(memberInformation.getAge());
				e.setDob(memberInformation.getDob());
				e.setEducationDetails(memberInformation.getEducationDetails());
				e.setMaritalStatus(memberInformation.getMaritalStatus());
				
				return new ResponseEntity<>(memberInformationService.updateMemberInformation(e),HttpStatus.OK);
			}catch(MemberInformationException e) {
